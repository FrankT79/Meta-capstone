  ...
  return (
    <main>
      ...
      <form action="submit">
        ...
        <input type="range" id='people' name='people' placeholder='people' min={1} max={12} value={guests} onChange={(e)=>setGuests(e.target.value)}/>
        <div>
        ...
        <div>
          ...
          <textarea id='comments' name='comments' rows={4} cols={25}/>
        </div>
